...
public:
    ...
    {
        segment_ = std::unique_ptr<managed_shared_memory_type>(                                 //segment created?
    ...
    SharedSegment(
        ...
        : SharedSegmentBase(name)
    {
        segment_ = std::unique_ptr<managed_shared_memory_type>(                                 //segment open?
    ...
    SharedSegment(
        ...
        : SharedSegmentBase(name)
    {
        segment_ = std::unique_ptr<managed_shared_memory_type>(                                 //segment open read only?             
    ...
    SharedSegment(
        ...
        : SharedSegmentBase(name)
    {
        segment_ = std::unique_ptr<managed_shared_memory_type>(                                 //segment open or create?
            ...
            const std::string& domain_name)
    {
        ...
        {                                                     
            std::cout << "Failed to create segment " << uuid.to_string() << ": " << e.what() << std::endl;
            throw;
        }
    }
